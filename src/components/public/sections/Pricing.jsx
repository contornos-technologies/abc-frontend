...
const highlights = [
  {
    ...
    description: "Bolsas parciais e integrais para estudantes com bom desempenho académico.",
  },
  {
    icon: Users,
    title: "Vagas Limitadas",
    description: "Turmas reduzidas para garantir qualidade e atenção a cada estudante.",
  },
  {
    icon: CreditCard,
    title: "Pagamento Flexível",
    description: "Facilidade de pagamento em prestações, de acordo com o pacote de disciplinas escolhido.",
  },
];
      ...
      <div className="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto">
          <h2 className="text-[24px] sm:text-[36px] lg:text-[42px] leading-[1.15] font-extrabold text-[#071C35]">
            Planos e{" "}
            <span className="text-[#1565A8]">Preços</span>
          </h2>
        ...
        {/* ───────────────── INCLUDED ───────────────── */}
        <div className="bg-white rounded-[16px] border border-[#E7EDF5] shadow-[0_4px_20px_rgba(0,0,0,0.03)] p-6 sm:p-8 mb-8 lg:mb-12">
