  ...
  >
    <X size={20} />
        ...
        <div className="p-6 border-b border-white/10">
          ...
          <div className="font-semibold text-sm truncate">{user?.fullName || 'Estudante'}</div>
            ...
            return (
              <button
                ...
                className={`w-full flex items-center gap-3 px-4 py-3 rounded-lg mb-1 transition-all text-left ${
                  isActive ? 'bg-[#F69220] text-white' : 'text-white/80 hover:bg-white/10'
                }`}
              >
                <Icon size={20} />
        ...
        <div className="p-4 border-t border-white/10">
          <button onClick={handleLogout} className="w-full flex items-center gap-3 px-4 py-3 rounded-lg text-red-300 hover:bg-white/10 transition-colors">
            <LogOut size={20} />
